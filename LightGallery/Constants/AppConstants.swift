...
enum AppConstants {
    ...
    /// App Bundle ID
    static let bundleID = "joyhisn.LightGallery"
    
    /// App Name
    static let appName = "LightGallery"
    
    // MARK: - Subscription Product IDs
    
    /// Pro Monthly subscription product ID
    static let proMonthlyProductID = "joyhisn.LightGallery.pro.monthly"
    
    /// Pro Yearly subscription product ID
    static let proYearlyProductID = "joyhisn.LightGallery.pro.yearly"
    
    /// Max Monthly subscription product ID
    static let maxMonthlyProductID = "joyhisn.LightGallery.max.monthly"
    
    /// Max Yearly subscription product ID
    static let maxYearlyProductID = "joyhisn.LightGallery.max.yearly"
}
