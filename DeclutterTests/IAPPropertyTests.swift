...
final class IAPPropertyTests: XCTestCase {
    ...
    func testIOSPaymentRouting() async throws {
        ...
        for iteration in 1...100 {
            ...
            let productId = "joyhisn.Declutter.\(tier.rawValue).\(period.rawValue)"
            ...
            XCTAssertTrue(
                productId.hasPrefix("joyhisn.Declutter."),
        ...
        for iteration in 1...100 {
            do {
                ...
                for product in products {
                    XCTAssertTrue(
                        product.id.hasPrefix("joyhisn.Declutter."),
    ...
    func testReceiptVerification() async throws {
        ...
        for iteration in 1...100 {
            ...
            let productId = ["joyhisn.Declutter.pro.monthly", "joyhisn.Declutter.pro.yearly",
                           "joyhisn.Declutter.max.monthly", "joyhisn.Declutter.max.yearly"].randomElement()!
    ...
    func testVerificationFailurePreventsActivation() async throws {
        ...
        for iteration in 1...100 {
            ...
            let product = SubscriptionProduct(
                id: "joyhisn.Declutter.\(tier.rawValue).\(period.rawValue)",
                tier: tier,
                billingPeriod: period,
                price: 10,
                currency: "CNY",
